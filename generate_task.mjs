...
// Mock dependencies
fs.writeFileSync('src/data/cityItineraryData.js', 'export const CITY_ITINERARY_DATA = {};');
fs.writeFileSync('src/utils/itineraryEngine.js', 'export const buildDynamicItinerary = () => {};');
